...
```{r}
vcf1 <- read.vcfR("../input/Xylaria_166_genomes.MinQG30.MinDP2.MaxMiss0.7.recode.Homozygous.recode.recode.vcf.maf.ld.0.1.vcf")
...
As you see, this object has a total of 163 genotypes (All necrophora), and we have filtered out some individuals with more than 70% missing data using vcf tools (see materials and methods).
...
Since we removed missing data over 90% was found, we move on to the analyses:
